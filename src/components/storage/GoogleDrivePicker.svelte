...
<div class="gdrive-picker">
    <button class="clear gdrive-btn" class:loading disabled={disabled || loading} onclick={openPicker} type="button">
        ...
        <span class="gdrive-label">{loading ? $t('songs.resource.drive-loading') : $t('songs.resource.select')}</span>
    </button>
</div>
