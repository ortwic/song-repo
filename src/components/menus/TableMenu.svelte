...
<section class="menu">
    {#if tableContext.addAction}
        <div class="row">
            <MenuButton title={tableContext.addAction.label} onclick={tableContext.addAction.action}>
    ...
    {#if tableContext.exportAction}
        <div class="row">
            <MenuButton className="no-padding" title="Export CSV" onclick={() => download('csv', { delimiter: ';' })}>
                <FileIcon type="CSV" fill="OliveDrab"></FileIcon>
            </MenuButton>
            <MenuButton className="no-padding" title="Export JSON" onclick={() => download('json')}>
            ...
            <MenuButton className="no-padding" title="Export PDF" onclick={downloadPdf}>
