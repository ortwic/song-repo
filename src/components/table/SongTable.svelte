<script lang="ts">
    ...
    const columns: ColumnDefinition[] = [
      ...
      column("Style", "style", "13%", "string", autoFilter(), comboBoxEditor(), { visible: false, cellEdited: updateHandler('artist') }),
      ...
      column("Source", "source", "25%", "string", autoFilter(), format.marked, { visible: false, editor: 'input', cellEdited: updateHandler() }),
      column("Key", "key", "90", "string", autoFilter(), { visible: false, editor: 'input', cellEdited: updateHandler() }),
      column("Time", "time", "90", "string", autoFilter(), { visible: false, editor: 'input', cellEdited: updateHandler() }),
      column("BPM", "bpm", "90", "string", autoFilter(), { visible: false, editor: 'input', cellEdited: updateHandler() }),
      column("Features", "features", "14%", "string", autoFilter(), format.label, { visible: false, editor: 'input', cellEdited: updateHandler() }),
      column("Labels", "tags", "14%", "string", autoFilter(), format.label, { editor: 'input', cellEdited: updateHandler() }),
      column("Learned", "learnedOn", "14%", "date", autoFilter(), format.timestamp, { visible: false, editor: 'date', cellEdited: updateHandler() }),
